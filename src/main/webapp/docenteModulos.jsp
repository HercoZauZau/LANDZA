...
<body onload="listaVazia()">
	<div class="navigation">
		<ul>
			...
			<li class="list"><a href="listaEstudantes"> <span class="icon"><img
						src="assets/img/icon/263070.png" alt="" /></span> <span class="title">Estudantes</span>
			</a></li>
			<li class="list active"><a href="docenteModulos"> <span class="icon"><img
						src="assets/img/icon/263081.png" alt="" /></span> <span class="title">Disciplinas</span>
			</a></li>
			
			<li class="list prs"><a href="docentePresencas"> <span class="icon"><img
						src="assets/img/icon/263089.png" alt="" /></span> <span class="title">Presenças</span>
			</a></li>
			<li class="list"><a href="docentePerfil"> <span class="icon"><img
	...
	<div class="principal">
		...
		<img class="menuMobile" src="assets/img/icon/3917762.png" alt="">
		 <div class="vetor-final">
          <h1>Lista de Módulos (<%out.print(request.getAttribute("meuModulo"));%>)</h1>
