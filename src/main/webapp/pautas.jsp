...
<%@ page import="model.Pautas"%>
<%@ page import="java.util.ArrayList"%>
<%
@SuppressWarnings("unchecked")
ArrayList<Pautas> lista = (ArrayList<Pautas>) request.getAttribute("conta");
%>
...
<body onload="listaVazia()">
	<div class="navigation">
		<ul>
			...
			<li class="list active"><a href="pautas"> <span class="icon"><img
	...
	<div class="principal">
		...
		<img class="menuMobile" src="assets/img/icon/3917762.png" alt="">
          ...
          <h1>Pautas (R.I.P)</h1>
          <img src="assets/img/images/analysis.jpg" alt="">
        </div>
        ...
        <h1>Opa! Nada encontrado!<h1/>
			...
			<table class="tabelaFinal scroll" >
				...
				<tbody>
					...
					%>
					<tr>
						<td><%=lista.get(i).getSem()%></td>
						<td><%=lista.get(i).getNome() + " (" + lista.get(i).getCod() + ")"%></td>
						<td class="divNota"><%=lista.get(i).getTeo()%></td>
						<td class="divNota"><%=lista.get(i).getPra()%></td>
					</tr>
